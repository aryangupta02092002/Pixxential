        ...
        <section className='min-h-screen flex items-center justify-center relative overflow-hidden'>
            <div className='text-center z-10 px-6'>
                <div className={`transition-all duration-1000 ${textVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
                    <h1 className='text-2xl md:text-9xl font-black mb-6 tracking-tight'>
                        <span className='bg-gradient-to-r from-blue-600 via-purple-500 to-cyan-400 bg-clip-text text-transparent animate-pulse'>
                            Make Magic.
                        </span>
                        <br />
                        <span className='text-white'>No Limits Attached.</span>
                    </h1>

                    <p className='text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed'>
                        Professional-grade image editing, powered by cutting-edge AI.
                        Crop, resize, enhance, and remove backgrounds—effortlessly.
                    </p>
                ...
                <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-6 transform-gpu">
                    <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 min-h-96">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="text-gray-400 text-sm">Pixxential Pro</div>
                        </div>
